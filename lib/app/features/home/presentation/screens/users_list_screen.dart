  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          "User Directory",
          style: TextStyle(color: context.appColors.gold),
        ),
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return Center(
              child: Text(
                "Error loading users.",
                style: TextStyle(color: context.appColors.txt3),
              ),
            );
          }
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return Obx(() {
                ...
                return InkWell(
                  onTap: amIAdmin
                      ? () => _showRoleChangeSheet(context, uid, fullName, role)
                      : null,
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(16),
                      border: Border.all(
                        color: role == 'admin' ? stColors.goldD : stColors.bdr,
                      ),
                    ),
                    child: Row(
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              // if (email.isNotEmpty && email != 'No phone') ...[
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(fontSize: 14, color: colors.txt2),
            ),
            ...
            ListTile(
              leading: Icon(
                Icons.shield,
                color: currentRole == 'admin' ? colors.gold : colors.txt3,
              ),
              title: Text(
                "Admin",
                style: TextStyle(
                  color: currentRole == 'admin' ? colors.gold : colors.txt,
                ),
              ),
              ...
              onTap: () async {
                ...
                try {
                  ...
                  Get.snackbar(
                    "Error",
                    "Failed to update role. Please check Firebase Database Rules.",
                    snackPosition: SnackPosition.BOTTOM,
            ...
            ListTile(
              leading: Icon(
                Icons.person,
                color: currentRole == 'user' ? colors.gold : colors.txt3,
              ),
              title: Text(
                "User",
                style: TextStyle(
                  color: currentRole == 'user' ? colors.gold : colors.txt,
                ),
              ),
