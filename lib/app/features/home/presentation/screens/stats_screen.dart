...
class StatsScreen extends GetView<HomeController> {
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                unselectedLabelColor: appColors.txt3,
          ...
          Expanded(
            child: TabBarView(
              children: [
                _buildStatsList(context, controller.allTimeStats, "allTimeGrand".tr),
                _buildStatsList(context, controller.todayStats, "todayGrand".tr),
  ...
  Widget _buildStatsList(BuildContext context, Map<String, int> statsMap, String grandTitle) {
    return Obx(() {
      final appColors = context.appColors;
      int grandTotal = 0;
      ...
      if (grandTotal == 0) {
        return Center(
          child: Text("No records found", style: TextStyle(color: appColors.txt3, letterSpacing: 2)),
        );
      }
        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                Text(grandTitle.toUpperCase(), style: TextStyle(fontSize: 11, letterSpacing: 2, color: appColors.txt2)),
          ...
          Text("catBreakdown".tr.toUpperCase(), style: TextStyle(fontSize: 10, letterSpacing: 3, color: appColors.txt3)),
